import { SignupInput } from "@akashgupta15/medium-common";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    { type === 'signup' ? <LabelledInput label="Name" type="text" placeholder="Harkirat Singh..." onChange={(e) => {
                        setPostInputs(c => ({
                            ...c,
                            name: e.target.value
                        }))
                    }} /> : "" }
                    <LabelledInput label="Email" type="email" placeholder="harkirat@gmail.com" onChange={(e) => {
                        setPostInputs(c => ({
                            ...c,
